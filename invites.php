...
where r.stat = 5 and r.userid='$userid5' and t.stat=0";
...
while($row = $result->fetch_assoc()){
    ...
    while($row6 = $resultname->fetch_assoc()){
        ...
        $userid_creater = $row6['userid'];
    }

    $query1 = "SELECT * from trips WHERE userid=$userid_creater";
        $result1 = mysqli_query($conn,$query1);
        $rowcount1 = mysqli_num_rows($result1);

        $query2 = "SELECT * from people_going_to_trips WHERE userid=$userid_creater";
    ...
    echo("<div class='blog-body'>");
        ...
        echo("<h1><a href='#'>Invited You To Join You To $trip_name On $date_display</a></h1>");
        echo("</div>");
    ...
    echo("<hr style='border-width: 1px 1px 0;
        ...
        echo("<ul>");
            ...
            echo("<input id='accept' name='invite_accept' class='accept' type='submit' value='Accept'/>");
            echo("<input id='reject' name='invite_reject' class='accept' type='submit' value='Reject'/>");
